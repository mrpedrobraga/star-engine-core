...
func _update_props():
	...
	PROPERTY ("Input/X+", &"input_action_x_pos", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/X-", &"input_action_x_neg", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/Y+", &"input_action_y_pos", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/Y-", &"input_action_y_neg", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/Z+", &"input_action_z_pos", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/Z-", &"input_action_z_neg", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/JUMP", &"input_action_jump", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
	PROPERTY ("Input/SPECIAL", &"input_action_OK", TYPE_STRING, PROPERTY_HINT_ENUM_SUGGESTION, _join_commas(actions))
